...
const Features = () => {
  ...
  return (
    <section
      id="program"
      className="bg-gradient-to-r from-[#a11d1d] to-[#531d1d] 
  pb-12 pt-8 md:py-16 text-center px-2 sm:px-4 font-poppins 
  w-full h-auto mt-[8rem]"
    >
          ...
          <div className="hidden md:block">
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-5">
              {programs.map((program, index) => (
                <div
                  key={index}
                  className={`bg-white p-5 shadow-md hover:shadow-lg transition rounded-xl 
              ${
                program.title === "Gold"
                ...
                >
                  {program.tag && (
                    <div
                      className="absolute -top-0 left-0 w-full bg-red-700 
                text-white py-2 text-sm font-semibold text-center"
                    >
                      {program.tag}
                    </div>
                  )}
                  ...
                  <div className="text-sm text-yellow-600 font-medium mb-4 whitespace-pre-line leading-tight">
                    {program.description}
                  </div>
              ...
              {programs.map((program, index) => (
                ...
                >
                  {program.tag && (
                    <div
                      className="absolute -top-0 left-0 w-full bg-red-700 
                text-white py-2 text-xs font-semibold text-center"
                    >
                      {program.tag}
                    </div>
                  )}
