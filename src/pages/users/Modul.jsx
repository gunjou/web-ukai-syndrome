...
import ModulListContent from "./MateriListContent"; // Ganti nama jika perlu
import Api from "../../utils/Api"; // menggunakan instance axios

// Komponen untuk daftar folder modul
const ModulList = ({ onFolderClick }) => {
...
// Komponen untuk menampilkan konten modul
const FolderContent = () => {
  return <ModulListContent />;
};
...
const Modul = () => {
  ...
  const basePath = "/dashboard/modul";
    ...
    <div className="bg-white w-full h-auto h-p-6">
      <div className="w-full bg-gray-100 p-4 rounded-[20px]">
        ...
        <div className="flex items-center justify-between mb-4">
          <h1 className="text-2xl font-semibold">Modul Explorer</h1>
        ...
        <Routes>
          <Route
            path="/"
            element={<ModulList onFolderClick={handleFolderClick} />}
          />
