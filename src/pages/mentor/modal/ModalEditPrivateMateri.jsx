// src/components/mentor/modal/ModalEditPrivateMateri.jsx
...
const ModalEditPrivateMateri = ({ isOpen, onClose, materi, onSuccess }) => {
  ...
  useEffect(() => {
    if (materi) {
      setForm({
        ...
        visibility: materi.visibility || "open",
  ...
  const handleSubmit = async () => {
    try {
      ...
      await Api.put(`/kelas-private/materi/${materi.id_materi_private}`, {
        judul: form.judul,
        ...
        >
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">
              Perbarui informasi materi private
            </p>
          </div>
...
export default ModalEditPrivateMateri;
