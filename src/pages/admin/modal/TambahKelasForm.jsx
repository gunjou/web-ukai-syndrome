...
const TambahKelasForm = ({ setShowModal, fetchKelas }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.success(`Kelas "${formData.nama_kelas}" berhasil ditambahkan!`);
  ...
  return (
    <div className="relative">
      <h2 className="text-lg font-bold mb-4 text-center">Tambah Kelas Baru</h2>
